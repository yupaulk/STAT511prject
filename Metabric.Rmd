...
# Create a table of gene name and ID
gene_names <- epxression[, c(1, 2)]
...
# Get outcome data
outcome <- fread("metabric/brca_metabric_clinical_data.tsv", header = TRUE, sep = "\t")
...
levels(outcome$`Overall Survival Status`) <- c(0,1)
